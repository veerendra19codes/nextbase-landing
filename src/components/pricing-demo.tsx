...
const PricingDemo = () => {
    ...
    const PricingCards = () => (
        <div className="relative z-10 flex w-auto flex-col  justify-center gap-8 lg:flex-row lg:gap-4">
            {pricingPlans.map((plan, index) => (
                <div
                    key={index}
                    className="rounded-xl border-[1px] border-gray-300 p-6 text-left dark:border-gray-600 w-[350px] hover:bg-gray-100 dark:hover:bg-gray-800 pl-1/2"
                >
                    {plan.name == "Standard" ? (
