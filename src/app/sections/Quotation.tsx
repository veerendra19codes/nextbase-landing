...
const Quotation = () => {
    return (
        <div className="quote w-full bg-gray-100 dark:bg-gray-800  flex flex-col justify-center items-center gap-4 py-24">
            ...
            <div className="quote text-3xl font-semibold w-[800px] text-start lg:text-center">Lorem ipsum dolor sit amet consectetur adipisicing elit. Error nisi iusto odit beatae nemo expedita.</div>
