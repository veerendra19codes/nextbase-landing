...
import { CalendarDays, ArrowRight, File, TextCursorInput } from "lucide-react"
import { Share2Icon } from "lucide-react";
import { AnimatedBeamMultipleOutput }
    from "@/components/animated-beam-multiple-output";
...
const Features = () => {
    ...
    return (
        <div className="features flex flex-col lg:justify-center items-start lg:items-center gap-4 py-24 px-4 lg:px-0">
            ...
            <div className="paragraph text-xl text-start lg:text-center text-gray-500 w-[900px] lg:px-16 dark:text-gray-400">Discover the ultimate insights into cutting-edge advancements. Our next-level features guide reveals the essentials for staying ahead.</div>

            <div className="bento lg:w-2/3 w-full items-center">
                <BentoGrid >
